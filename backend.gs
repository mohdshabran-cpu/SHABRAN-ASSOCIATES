...
function emailShell_(inner) {
  return '<div style="font-family:Arial,Helvetica,sans-serif;max-width:600px;margin:0 auto;border:1px solid #e2d9c0;border-radius:12px;overflow:hidden">' +
    '<div style="background:#0d2e21;color:#e3c878;padding:22px 28px">' +
...
function createBooking_(b) {
  ...
  sendMail_(CONFIG.OWNER_EMAIL,
    ...
    emailShell_(
      '<h3 style="margin:0 0 6px;color:#0d2e21">Tempahan Baru Diterima</h3>' +
      '<p style="margin:0 0 18px;color:#6b6f66">Sila semak dan sahkan bayaran sebelum mengesahkan tempahan.</p>' +
      bookingTableHtml_(b) +
      '<p style="margin-top:20px"><a href="https://docs.google.com/spreadsheets/d/' + SS.getId() + '/edit" style="background:#0d2e21;color:#e3c878;padding:10px 20px;border-radius:6px;text-decoration:none;display:inline-block">Buka Google Sheet Tempahan</a></p>'
    ));
  ...
  sendMail_(b.email,
    ...
    emailShell_(
      '<h3 style="margin:0 0 6px;color:#0d2e21">Assalamualaikum ' + b.name + ',</h3>' +
